...
const initialSections = [
  ...
  },
  {
    ...
    mediaUrl: '/images/about_1.jpeg',
    layoutStyle: 'hero',
    order: 1,
    buttons: [{ label: 'Explore Our Story', link: '#our-story' }],
  },
  {
    page: 'about',
    sectionKey: 'about_story',
    kicker: 'Our Story',
    title: 'Pioneering Deep Tech Innovation Since Day One',
    subtitle: 'From a boutique research team to a full-spectrum engineering partner for global enterprises.',
    mediaUrl: '/images/our_story.jpeg',
    layoutStyle: 'split',
    order: 2,
  },
  {
    ...
    kicker: 'Flagship Products & Client Case Studies',
    title: 'Engineering Products That Solve Mission-Critical Challenges',
    subtitle: 'Explore our proprietary AI document engines, industrial IoT hubs, multi-cloud Kubernetes orchestrators, and enterprise solutions.',
    mediaUrl: '/images/hero-visual.jpg',
    layoutStyle: 'hero',
    order: 1,
    buttons: [{ label: 'Explore Flagship Products', link: '#products' }],
  },
  {
    page: 'contact',
    ...
    mediaUrl: '/images/contact-banner.png',
    layoutStyle: 'hero',
    order: 1,
  },
  {
    ...
    kicker: 'Porulon Insights & Engineering Blog',
    title: 'Deep Dives into AI, Cloud Systems & Systems Engineering',
    subtitle: 'Technical articles, architectural breakdowns, and industry analyses written by our principal engineers.',
